...
export default function Banner() {
  return (
    <Container>
      <section className="relative h-[560px] mt-10 overflow-hidden rounded-xl">
        {/* Background image */}
        <Image
          src="/banner.webp"
          ...
          <div className="relative z-10 h-full flex items-center justify-between gap-10">
            ...
            <div className="max-w-xl text-white">
              <h1 className="text-5xl font-bold text-yellow-500 mb-5">
                Bienvenido a Maestro Especial
              </h1>

              <p className="text-xl leading-relaxed">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Voluptas ex provident, accusamus soluta esse autem voluptatem
                iste
              </p>
            </div>
